...
const en = {
  ...
  announcementSettings: {
    ...
    attachmentHint: 'Supported formats: PDF, Word, Excel, PowerPoint. Max total size: 100 MB. (PDF preview only)',
    ...
    libraryDocsLabel: 'Library Documents',
    libraryDocsHint: 'Select documents from the library to use as announcement attachments',
    libraryDocsPlaceholder: 'Select documents...',
    libraryDocsLoading: 'Loading...',
    libraryDocsEmpty: 'No documents in this library',
    libraryDocsCount: '{count} library doc(s)',
    hasLibraryDocs: 'Has library docs',
    selectCatalogLabel: 'Select Library',
    selectCatalogHint: 'First select a library, then choose documents from it',
    selectCatalogPlaceholder: 'Select a library...',
  ...
  librarySettings: {
    ...
    uploadDocument: 'Upload Knowledge Files',
    editDocument: 'Edit',
